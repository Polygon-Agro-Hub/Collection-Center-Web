...
downloadReport(): void {
  ...
  let leftY = addField('From', '12', margin + 5, y, halfWidth);
  let rightY = addField('To', '12', margin + halfWidth + 10, y, halfWidth);
  ...
  this.farmerDataArr.forEach(row => {
    ...
    doc.text(String(row.ReportDate), startX + colWidths[0] / 2, y + 6, { align: 'center' });
